...
public class Items {
    ...
    public static void init() {
        ...
        BATPACK_4 = registry.registerItem(CompatIdentifier.of("better_batpack", "batpack4"), () -> new BetterBatpackItem(TechRebornConfig.lithiumBatpackCharge * 4, new BBArmorMaterial("batpack4"), RcEnergyTier.MEDIUM));
        BATPACK_16 = registry.registerItem(CompatIdentifier.of("better_batpack", "batpack16"), () -> new BetterBatpackItem(TechRebornConfig.lithiumBatpackCharge * 16, new BBArmorMaterial("batpack16"), RcEnergyTier.HIGH));
        BATPACK_64 = registry.registerItem(CompatIdentifier.of("better_batpack", "batpack64"), () -> new BetterBatpackItem(TechRebornConfig.lithiumBatpackCharge * 64, new BBArmorMaterial("batpack64"), RcEnergyTier.EXTREME));
        BATPACK_128 = registry.registerItem(CompatIdentifier.of("better_batpack", "batpack128"), () -> new BetterBatpackItem(TechRebornConfig.lithiumBatpackCharge * 128, new BBArmorMaterial("batpack128"), RcEnergyTier.INSANE));
